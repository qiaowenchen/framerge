...
text(0, ylim(2), 'a', 'VerticalAlignment', 'bottom', 'HorizontalAlignment', 'center','FontSize',18)
...
% letter
ylim = get(gca, 'ylim');  % Get the current y-axis limits
text(0, ylim(2), 'b', 'VerticalAlignment', 'bottom', 'HorizontalAlignment', 'center','FontSize',18)
...
% letter
ylim = get(gca, 'ylim');  % Get the current y-axis limits
text(-0.2, ylim(2), 'c', 'VerticalAlignment', 'bottom', 'HorizontalAlignment', 'center','FontSize',18)
% Legend
...
set(label1, 'position', [2.5000 -1.0 -1])
ylabel('Time(seconds)','FontSize',18)
% Color
...
set(label2,'position',[2.5000 -1 -1])
% Color
...
set(label3,'position',[2.5000 -100 -1])
% Color
...
% print(['figure1','.eps'],'-depsc','-r600');% save eps with 600dpi
% print(gcf, 'hdd', '-dsvg'); % save svg